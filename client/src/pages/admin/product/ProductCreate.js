...
const initialState = {
  ...
  languages: ["English", "Tamil", "Hindi", "German", "French"],
  publishers: ["Jaico Publishing House", "Westland Publications", "Penguin Random House India", "HarperCollins Publishers India", "Srishti Publishers","Fingerprint Publishing"],
  language: "English",
